...
exports.RefreshTokenDto = exports.AuthCredentialsDto = void 0;
...
let EmailOrPhoneConstraint = class EmailOrPhoneConstraint {
    validate(value) {
        if (typeof value !== 'string')
            return false;
        return (0, class_validator_2.isEmail)(value) || (0, class_validator_2.isPhoneNumber)(value);
    }
    defaultMessage(_args) {
        return 'id must be a valid email or phone number';
    }
};
EmailOrPhoneConstraint = __decorate([
...
__decorate([
    ...
    (0, class_validator_1.Validate)(EmailOrPhoneConstraint),
